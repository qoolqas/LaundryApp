package com.example.laundryapp.connection;


import com.example.laundryapp.model.create.CreateResponse;
import com.example.laundryapp.model.delete.DeleteResponse;
import com.example.laundryapp.model.edit.EditResponse;
...
public interface Service {
    ...
    @GET("read.php")
    Call<ProdukResponse> getHistori(@Query("history") String histori);
